...
### 멀티 페이지 애플리케이션
( [HTML+vanilaJS/jQuery/Lib](https://github.com/dohehehe/FES09-React/tree/main/workspace/ch01-buildup/todolist), [라이브러리 개발](https://github.com/dohehehe/FES09-React/tree/main/workspace/ch01-buildup/counter) )
...
### [단일 페이지 애플리케이션(SPA, Single Page Application)](https://github.com/dohehehe/FES09-React/tree/main/workspace/ch01-buildup/react)
...
## 1-2 [리액트 개발에 자주 사용하는 자바스크립트 문법](https://github.com/dohehehe/FES09-React/tree/main/workspace/ch01-buildup/js-review)
* Arrow Function
* 구조 분해 할당
* 전개 연산자
* 삼항 조건 연산자
